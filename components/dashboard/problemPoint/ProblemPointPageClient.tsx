            ...
            <div className="relative z-10 w-full max-w-4xl">
                <div className="bg-white/95 backdrop-blur-sm rounded-2xl shadow-2xl border border-gray-100 overflow-hidden">
                    ...
                    <div className="bg-gradient-to-r from-red-600 via-red-700 to-rose-800 p-8 text-white text-center">
                        ...
                        <h1 className="text-3xl font-bold mb-2">Problem Points Management</h1>
                        <p className="text-red-100">Manage student behavioral records and problem points</p>
                    </div>
                        ...
                        <div className="grid md:grid-cols-2 gap-6">
                            ...
                            >
                                <div className="flex flex-col items-center text-center">
                                    ...
                                    <h2 className="text-xl font-bold text-gray-800 mb-2">Create Record</h2>
                                    <p className="text-gray-600 text-sm">
                                        Assign new problem points to one or multiple students for disciplinary actions, lateness, or other issues.
                                    </p>
                                </div>
                            </button>
                            ...
                            >
                                <div className="flex flex-col items-center text-center">
                                    ...
                                    <h2 className="text-xl font-bold text-gray-800 mb-2">Manage Records</h2>
                                    <p className="text-gray-600 text-sm">
                                        View history, update existing records, or remove incorrect entries. Filter by class and student.
                                    </p>
                                </div>
                            </button>
                        </div>
